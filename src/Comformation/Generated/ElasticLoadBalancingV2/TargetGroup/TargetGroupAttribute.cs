...
namespace Comformation.ElasticLoadBalancingV2.TargetGroup
{
    ...
    public class TargetGroupAttribute
    {
        ...
        /// selects targets when routing requests. The value is round_robin or least_outstanding_requests. The
        ...
        /// value is true or false. The default is false. If the value is false and the request contains a
        /// duplicate header field name or query parameter key, the load balancer uses the last value sent by
        /// the client.
