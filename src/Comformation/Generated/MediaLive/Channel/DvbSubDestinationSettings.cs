...
namespace Comformation.MediaLive.Channel
{
    ...
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-medialive-channel-dvbsubdestinationsettings.html
    /// </summary>
    public class DvbSubDestinationSettings
    {
        ...
        /// <summary>
        /// ShadowColor
        /// Specifies the color of the shadow that is cast by the captions. All burn-in and DVB-Sub font
        /// settings must match.
        /// Required: No
        /// Type: String
        /// Update requires: No interruption
        ...
        /// <summary>
        /// Alignment
        /// If no explicit xPosition or yPosition is provided, setting the alignment to centered places the
        /// captions at the bottom center of the output. Similarly, setting a left alignment aligns captions to
        /// the bottom left of the output. If x and y positions are specified in conjunction with the alignment
        /// parameter, the font is justified (either left or centered) relative to those coordinates. Selecting
        /// &quot;smart&quot; justification left-justifies live subtitles and center-justifies pre-recorded subtitles.
        /// This option is not valid for source captions that are STL or 608/embedded. These source settings are
        /// already pre-defined by the captions stream. All burn-in and DVB-Sub font settings must match.
        /// Required: No
        /// Type: String
        /// Update requires: No interruption
        /// </summary>
        ...
        /// These source settings are already pre-defined by the captions stream. All burn-in and DVB-Sub font
        /// settings must match.
        /// Required: No
        /// Type: Integer
        /// Update requires: No interruption
        ...
        /// yPosition is provided, the captions are positioned towards the bottom of the output. This option is
        ...
        /// <summary>
        /// OutlineSize
        /// Specifies the font outline size in pixels. This option is not valid for source captions that are
        /// either 608/embedded or Teletext. These source settings are already pre-defined by the captions
        /// stream. All burn-in and DVB-Sub font settings must match.
        /// Required: No
        /// Type: Integer
        /// Update requires: No interruption
        ...
        /// <summary>
        /// TeletextGridControl
        /// Controls whether a fixed grid size is used to generate the output subtitles bitmap. This applies to
        /// only Teletext inputs and DVB-Sub/Burn-in outputs.
        /// Required: No
        /// Type: String
        /// Update requires: No interruption
        /// </summary>
