...
namespace Comformation.OpsWorksCM.Server
{
    ...
    public class EngineAttribute
    {
        ...
        /// required to access the Chef API. You can generate this key by running the following OpenSSL command
        /// on Linux-based computers. openssl genrsa -out pivotal_key_file_name. pem 2048 On Windows-based
        /// computers, you can use the PuTTYgen utility to generate a base64-encoded RSA private key. For more
        /// information, see PuTTYgen - Key Generator for PuTTY on Windows on SSH. com.
        ...
        /// Enterprise console webpage after the server is online. The password must use between 8 and 32 ASCII
        /// characters. PUPPET_R10K_REMOTE: The r10k remote is the URL of your control repository (for example,
        /// ssh://git@your. git-repo. com:user/control-repo. git). Specifying an r10k remote opens TCP port
        /// 8170. PUPPET_R10K_PRIVATE_KEY: If you are using a private Git repository, add
