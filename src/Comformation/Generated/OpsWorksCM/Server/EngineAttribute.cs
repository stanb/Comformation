...
namespace Comformation.OpsWorksCM.Server
{
    ...
    public class EngineAttribute
    {
        ...
        /// password must use between 8 and 32 ASCII characters. PUPPET_R10K_REMOTE: The r10k remote is the URL
        /// of your control repository (for example, ssh://git@your. git-repo. com:user/control-repo. git).
        ...
        /// Attribute names for Puppet Enterprise servers: PUPPET_ADMIN_PASSWORD PUPPET_R10K_REMOTE
