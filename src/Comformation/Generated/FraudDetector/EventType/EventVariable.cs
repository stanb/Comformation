...
namespace Comformation.FraudDetector.EventType
{
    ...
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-frauddetector-eventtype-eventvariable.html
    /// </summary>
    public class EventVariable
    {
        ...
        /// variables to your event type but not execute any changes to the variables.
        /// Required: No
        /// Type: Boolean
        /// Update requires: No interruption
        /// </summary>
        ...
        /// When defining a variable within a event type, you can only use the EVENT value for DataSource when
        /// the Inline property is set to true. If the Inline property is set false, you can use either EVENT or
