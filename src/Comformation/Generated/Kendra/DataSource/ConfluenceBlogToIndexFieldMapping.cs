...
namespace Comformation.Kendra.DataSource
{
    ...
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kendra-datasource-confluenceblogtoindexfieldmapping.html
    /// </summary>
    public class ConfluenceBlogToIndexFieldMapping
    {
        ...
        /// Required: Yes
        /// Type: String
        /// Allowed values: AUTHOR | DISPLAY_URL | ITEM_TYPE | LABELS | PUBLISH_DATE | SPACE_KEY | SPACE_NAME |
        /// URL | VERSION
