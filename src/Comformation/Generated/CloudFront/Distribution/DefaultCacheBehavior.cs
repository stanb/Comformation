...
namespace Comformation.CloudFront.Distribution
{
    ...
    public class DefaultCacheBehavior
    {
        ...
        /// content.
        /// 		
        /// If you want to require signed URLs in requests for objects in the target origin, 			specify a list
        /// of AWS account IDs. For more information, see Serving Private Content 			through CloudFront in the
        /// Amazon CloudFront Developer 			Guide.
        /// 	
        /// Required: No
        /// Type: List of String
