...
namespace Comformation.EC2.SpotFleet
{
    ...
    public class LaunchTemplateOverrides
    {
        ...
        /// <summary>
        /// Priority
        /// The priority for the launch template override. If OnDemandAllocationStrategy is set to prioritized,
        /// Spot Fleet uses priority to determine which launch template override to use first in fulfilling
        /// On-Demand capacity. The highest priority is launched first. Valid values are whole numbers starting
        /// at 0. The lower the number, the higher the priority. If no number is set, the launch template
