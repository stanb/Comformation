...
namespace Comformation.EC2.EC2Fleet
{
    ...
    public class FleetLaunchTemplateOverridesRequest
    {
        ...
        /// If the Spot AllocationStrategy is set to capacity-optimized-prioritized, EC2 Fleet uses priority on
        /// a best-effort basis to determine which launch template override to use in fulfilling Spot capacity,
        ...
        /// number is set, the launch template override has the lowest priority. You can set the same priority
        ...
        /// (for example, subnet-1234abcdeexample1, subnet-0987cdef6example2). A request of type instant can
