...
namespace Comformation.EC2.Instance
{
    ...
    public class InstanceResource : ResourceBase
    {
        public class InstanceProperties
        {
            ...
            /// <summary>
            /// CpuOptions
            /// The CPU options for the instance. For more information, see Optimize CPU options in the Amazon
            ...
            /// 			uses the old instance to roll back the stack to the previous working 			state. The old and new
