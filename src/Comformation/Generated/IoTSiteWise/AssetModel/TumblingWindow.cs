...
namespace Comformation.IoTSiteWise.AssetModel
{
    ...
    public class TumblingWindow
    {
        ...
        /// AWS IoT SiteWise computes the 1w interval the end of Sunday at midnight each week (UTC), the 1d
        /// interval at the end of each day at midnight (UTC), the 1h interval at the end of each hour, and so
        /// on.
        ...
        /// </summary>
        [JsonProperty("Offset")]
        public Union<string, IntrinsicFunction> Offset { get; set; }
