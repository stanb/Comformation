...
namespace Comformation.Batch.ComputeEnvironment
{
    ...
    public class Ec2ConfigurationObject
    {
        ...
        /// ECS_AL2 Amazon Linux 2− Default for all non-GPU instance families. ECS_AL2_NVIDIA Amazon Linux 2
        /// (GPU)−Default for all GPU instance families (for example P4 and G4) and can be used for all non AWS
        /// Graviton-based instance types. ECS_AL1 Amazon Linux. Amazon Linux is reaching the end-of-life of
        /// standard support. For more information, see Amazon Linux AMI.
        /// Required: Yes
        /// Type: String
        /// Minimum: 1
        /// Maximum: 256
