...
namespace Comformation.Athena.WorkGroup
{
    ...
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-athena-workgroup-workgroupconfiguration.html
    /// </summary>
    public class WorkGroupConfiguration
    {
        ...
        /// <summary>
        /// ResultConfiguration
        /// Specifies the location in Amazon S3 where query results are stored and the encryption option, if
        /// any, used for query results. For more information, see Working with Query Results, Output Files, and
        /// Query History.
        /// Required: No
