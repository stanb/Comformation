...
namespace Comformation.CodeDeploy.DeploymentGroup
{
    ...
    /// Deployment is a property of the AWS::CodeDeploy::DeploymentGroup resource that specifies an AWS CodeDeploy
    ...
    public class Deployment
    {
        ...
        /// want AWS CodeDeploy to continue the deployment lifecycle even if the ApplicationStop event fails on
        /// an instance, specify true. The deployment continues to the BeforeInstall deployment lifecycle event.
        /// If you want AWS CodeDeploy to stop deployment on the instance if the ApplicationStop event fails,
        /// specify false or do not specify a value.
        /// Required: No
        /// Type: Boolean
        /// </summary>
