...
namespace Comformation.ServiceDiscovery.Service
{
    ...
    public class DnsConfig
    {
        ...
        /// returns the applicable value for up to eight instances. For example, suppose the service includes
        /// configurations for one A record and a health check, and you use the service to register 10
        ...
        /// same weight, so you can&#39;t route more or less traffic to any instances. For example, suppose the
        /// service includes configurations for one A record and a health check, and you use the service to
