...
namespace Comformation.AutoScaling.AutoScalingGroup
{
    ...
    /// The InstancesDistribution property type describes an instances distribution for an Auto Scaling group with
    /// MixedInstancesPolicy. The instances distribution specifies the distribution of On-Demand Instances and Spot
    ...
    public class InstancesDistribution
    {
        ...
        /// On-Demand capacity cannot be fulfilled using your highest priority instance, then the Auto Scaling
        ...
        /// value blank (which is the default), the maximum Spot price is set at the On-Demand price. Minimum
