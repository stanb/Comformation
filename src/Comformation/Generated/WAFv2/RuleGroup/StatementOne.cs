...
namespace Comformation.WAFv2.RuleGroup
{
    ...
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-statementone.html
    /// </summary>
    public class StatementOne
    {
        ...
        public RateBasedStatementOne RateBasedStatement { get; set; }
        ...
        public AndStatementOne AndStatement { get; set; }
        ...
        public OrStatementOne OrStatement { get; set; }
        ...
        public NotStatementOne NotStatement { get; set; }
