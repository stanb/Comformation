...
namespace Comformation.Pinpoint.APNSChannel
{
    /// <summary>
    /// AWS::Pinpoint::APNSChannel
    /// A channel is a type of platform that you can deliver messages to. You can use the APNs channel to send push
    /// notification messages to the Apple Push Notification service (APNs). Before you use Amazon Pinpoint to send
    /// notifications to APNs, you have to enable the APNs channel for an Amazon Pinpoint app.
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-apnschannel.html
    /// </summary>
    public class APNSChannelResource : ResourceBase
    {
        public class APNSChannelProperties
        {
            /// <summary>
            /// BundleId
        ...
        public string Type { get; } = "AWS::Pinpoint::APNSChannel";

        public APNSChannelProperties Properties { get; } = new APNSChannelProperties();
