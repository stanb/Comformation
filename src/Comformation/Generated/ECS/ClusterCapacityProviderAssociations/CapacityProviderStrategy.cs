...
namespace Comformation.ECS.ClusterCapacityProviderAssociations
{
    ...
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-clustercapacityproviderassociations-capacityproviderstrategy.html
    /// </summary>
    public class CapacityProviderStrategy
    {
        ...
        /// are specified within a capacity provider strategy, at least one of the capacity providers must have
        /// a weight value greater than zero and any capacity providers with a weight of 0 will not be used to
        ...
        /// and both have a weight of 1, then when the base is satisfied, the tasks will be split evenly across
        /// the two capacity providers. Using that same logic, if you specify a weight of 1 for
        /// capacityProviderA and a weight of 4 for capacityProviderB, then for every one task that is run using
