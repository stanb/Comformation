...
namespace Comformation.ECS.Service
{
    ...
    /// The PlacementStrategies property describes how tasks for the Amazon Elastic Container Service (Amazon ECS)
    /// service are placed in an AWS::ECS::Service resource.
    ...
    public class PlacementStrategy
    {
        ...
        /// The random placement strategy randomly places tasks on available candidates. The spread placement
        /// strategy spreads placement across available candidates evenly based on the field parameter. The
        /// binpack strategy places tasks on available candidates that have the least available amount of the
        /// resource that is specified with the field parameter. For example, if you binpack on memory, a task
        /// is placed on the instance with the least amount of remaining memory (but still enough to run the
        /// task).
        /// Required: Yes
        /// Type: String
        /// Update requires: Replacement
