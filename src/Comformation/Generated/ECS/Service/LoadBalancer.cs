...
namespace Comformation.ECS.Service
{
    ...
    public class LoadBalancer
    {
        ...
        /// more information, see Registering Multiple Target Groups with a Service in the Amazon Elastic
        /// Container Service Developer Guide.
        /// For services using the CODE_DEPLOY deployment controller, you are required to define two target
        /// groups for the load balancer. For more information, see Blue/Green Deployment with CodeDeploy in the
        /// Amazon Elastic Container Service Developer Guide.
        /// Important If your service&#39;s task definition uses the awsvpc network mode (which is required for the
        /// Fargate launch type), you must choose ip as the target type, not instance, when creating your target
        /// groups because tasks that use the awsvpc network mode are associated with an elastic network
