...
namespace Comformation.ECS.TaskDefinition
{
    ...
    public class DockerVolumeConfiguration
    {
        ...
        /// because it is used for task placement. If the driver was installed using the 			Docker plugin CLI,
        /// use docker plugin ls to retrieve the driver name from 			your container instance. If the driver was
        /// installed using another method, use Docker 			plugin discovery to retrieve the driver name. For more
        /// information, see Docker 				plugin discovery. This parameter maps to Driver in the 			Create a
        /// volume section of the Docker Remote API and the 				xxdriver option to docker 				volume create.
        /// 	
        /// Required: No
        /// Type: String
        /// Update requires: Replacement
        ...
        /// Create a volume section of the 			Docker Remote API and the xxopt option to docker 				volume
        /// create.
        /// 	
        /// Required: No
        /// Type: Map of String
        ...
        /// Scope
        /// 		
        /// The scope for the Docker volume that determines its lifecycle. Docker volumes that are 			scoped to
        /// a task are automatically provisioned when the task starts and 			destroyed when the task stops.
