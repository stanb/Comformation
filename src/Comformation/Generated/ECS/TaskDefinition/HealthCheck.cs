...
namespace Comformation.ECS.TaskDefinition
{
    ...
    public class HealthCheck
    {
        ...
        /// The string array must start with CMD to execute the command 			arguments directly, or CMD-SHELL to
        /// run the command with the container&#39;s 			default shell. For example:
        /// 		
        ...
        /// 		
        /// Note If a health check succeeds within the startPeriod, then the container 				is considered healthy
