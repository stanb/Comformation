...
namespace Comformation.ECS.TaskDefinition
{
    ...
    public class ProxyConfiguration
    {
        ...
        /// 					container as defined by the user parameter in a container 					definition. This is used to
        ...
        /// traffic. If 						IgnoredUID is specified, this field can be empty. 			 				 AppPorts - (Required)
        /// The list of ports that the 					application uses. Network traffic to these ports is forwarded to the
        /// 						ProxyIngressPort and ProxyEgressPort. 			 				 ProxyIngressPort - (Required) Specifies the
        /// port that 					incoming traffic to the AppPorts is directed to. 			 				 ProxyEgressPort -
        ...
        /// not redirected to the 						ProxyEgressPort. It can be an empty list. 			 				 EgressIgnoredIPs -
        /// (Required) The egress traffic going to 					the specified IP addresses is ignored and not redirected
