...
namespace Comformation.AppMesh.Route
{
    ...
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appmesh-route-grpcretrypolicy.html
    /// </summary>
    public class GrpcRetryPolicy
    {
        ...
        public List<Union<string, IntrinsicFunction>> GrpcRetryEvents { get; set; }
