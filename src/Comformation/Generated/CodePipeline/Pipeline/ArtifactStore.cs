...
namespace Comformation.CodePipeline.Pipeline
{
    ...
    public class ArtifactStore
    {
        ...
        /// Service (AWS KMS) key. If this is undefined, the default key for Amazon S3 is used. To see an
        /// example artifact store encryption key field, see the example structure here:
        ...
        /// based on the name of the pipeline. You can use any S3 bucket in the same AWS Region as the pipeline
