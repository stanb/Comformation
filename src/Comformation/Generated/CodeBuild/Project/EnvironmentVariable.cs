...
namespace Comformation.CodeBuild.Project
{
    ...
    public class EnvironmentVariable
    {
        ...
        /// PARAMETER_STORE: An environment variable stored in Systems Manager Parameter Store. To learn how to
        /// specify a parameter store environment variable, see env/parameter-store in the AWS CodeBuild User
        /// Guide. PLAINTEXT: An environment variable in plain text format. This is the default value.
        ...
        /// displayed in plain text using the AWS CodeBuild console and the AWS CLI. For sensitive values, we
