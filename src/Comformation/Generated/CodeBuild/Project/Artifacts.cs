...
namespace Comformation.CodeBuild.Project
{
    ...
    public class Artifacts
    {
        ...
        /// CODEPIPELINE: The build project has build output generated through AWS CodePipeline. NO_ARTIFACTS:
        /// The build project does not produce any build output. S3: The build project stores build output in
