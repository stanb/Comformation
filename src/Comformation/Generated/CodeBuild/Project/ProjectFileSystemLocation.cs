...
namespace Comformation.CodeBuild.Project
{
    ...
    public class ProjectFileSystemLocation
    {
        ...
        /// mounts. For example, if the DNS name of a file system is fs-abcd1234. efs. us-west-2. amazonaws.
        /// com, and its mount directory is my-efs-mount-directory, then the location is fs-abcd1234. efs.
        /// us-west-2. amazonaws. com:/my-efs-mount-directory.
