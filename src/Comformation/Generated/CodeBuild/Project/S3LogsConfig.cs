...
namespace Comformation.CodeBuild.Project
{
    ...
    /// S3Logs is a property of the AWS CodeBuild Project LogsConfig property type that specifies settings for logs
    /// generated by an AWS CodeBuild build in an S3 bucket.
