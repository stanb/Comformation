...
namespace Comformation.WAF.XssMatchSet
{
    ...
    public class FieldToMatch
    {
        ...
        /// OPTIONS, PATCH, 				POST, and PUT. QUERY_STRING: A query string, which is the part of a URL that
        /// appears after a ? character, if any. URI: The part of a web request that identifies a resource, for
        /// example, /images/daily-ad. jpg. BODY: The part of a request that contains any additional data that
        /// you want to send to your web server 				as the HTTP request body, such as data from a form. The
        ...
        /// length of the body, you can create a size constraint set. 		 		 SINGLE_QUERY_ARG: The parameter in
        /// the query string that you will inspect, such as UserName or SalesRegion. The maximum length for
