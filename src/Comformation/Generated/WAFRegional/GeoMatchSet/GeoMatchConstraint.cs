...
namespace Comformation.WAFRegional.GeoMatchSet
{
    ...
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafregional-geomatchset-geomatchconstraint.html
    /// </summary>
    public class GeoMatchConstraint
    {
        ...
        /// Required: Yes
        /// Type: String
        /// Allowed Values: AD | AE | AF | AG | AI | AL | AM | AO | AQ | AR | AS | AT | AU | AW | AX | AZ | BA |
