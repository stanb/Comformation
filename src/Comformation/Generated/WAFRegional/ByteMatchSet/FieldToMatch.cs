...
namespace Comformation.WAFRegional.ByteMatchSet
{
    ...
    /// FieldToMatch is a property of the AWS WAF ByteMatchSet ByteMatchTuples property that specifies the part of a
    /// web request that you want AWS WAF to search, such as a specific header or a query string.
