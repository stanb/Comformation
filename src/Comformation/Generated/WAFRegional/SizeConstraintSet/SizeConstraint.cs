...
namespace Comformation.WAFRegional.SizeConstraintSet
{
    ...
    /// SizeConstraint is a property of the AWS::WAFRegional::SizeConstraintSet resource that specifies a size
    /// constraint and which part of a web request that you want AWS WAF to constrain.
    ...
    public class SizeConstraint
    {
        ...
        /// the Size content for the SizeConstraint data type in the AWS WAF Regional API Reference.
        /// Required: Yes
        /// Type: Integer
        /// </summary>
        [JsonProperty("Size")]
        ...
        /// valid values, see the TextTransformation content for the SizeConstraint data type in the AWS WAF
