...
namespace Comformation.WAFRegional.SizeConstraintSet
{
    ...
    /// FieldToMatch is a property of the AWS WAF Regional SizeConstraintSet SizeConstraint property that specifies
    /// the part of a web request that you want AWS WAF to check for a size constraint, such as a specific header or a
    /// query string.
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafregional-sizeconstraintset-sizeconstraint-fieldtomatch.html
    /// </summary>
