...
namespace Comformation.WAFRegional.XssMatchSet
{
    ...
    /// FieldToMatch is a property of the AWS WAF Regional XssMatchSet XssMatchTuple property that specifies the part
    /// of a web request that you want AWS WAF to search, such as a specific header or a query string.
    /// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafregional-xssmatchset-xssmatchtuple-fieldtomatch.html
    /// </summary>
